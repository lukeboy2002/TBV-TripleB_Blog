                    ...
                    @foreach($users as $user )
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                <img src="{{ asset('storage/' . $user->member->image) }}" alt="{{ $user->username }}" class="h-10 w-auto" >
                            </th>
                            <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                <a href="{{ route('admin.members.edit' , $user->username) }}">{{ $user->username }}</a>
                            </th>
                            <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                {{ $user->email }}
                            </th>
                            ...
                            <td class="px-6 py-4 flex justify-end space-x-4">
                                @if ($user->trashed())
                                    ...
                                    @endrole
                                @else
                                    <x-link.btn-primary href="{{ route('admin.members.edit' , $user) }}" class="px-2.5 py-2.5 text-xs font-medium"><i class="fa-solid fa-pen-to-square"></i></x-link.btn-primary>
